    ...
    <section class="hotel-rooms spad-2">
        <div class="container">
            ...
            <?php
            	...
            	if (!isset($bathroom) && !isset($bedroom) && isset($price)) {
            		$sql2 = "SELECT * from property where city='$city' AND price<='$price' AND type='$type';";
            		$result2 = mysqli_query($conn, $sql2);
            		$resultcheck = mysqli_num_rows($result2);
            	}
            	if (!isset($bathroom) && !isset($bedroom) && $price==null) {
            		$sql2 = "SELECT * from property where city='$city' AND type='$type';";
            		$result2 = mysqli_query($conn, $sql2);
            		$resultcheck = mysqli_num_rows($result2);
            	}
            	if (!isset($bathroom) && isset($bedroom) && $price==null) {
            		$sql2 = "SELECT * from property WHERE bedroom='$bedroom';";
            		$result2 = mysqli_query($conn, $sql2);
            		$resultcheck = mysqli_num_rows($result2);
            	}
            	if (isset($bathroom) && !isset($bedroom) && $price==null) {
            		$sql2 = "SELECT * from property where city='$city' AND bathroom='$bathroom' AND type='$type';";
            		$result2 = mysqli_query($conn, $sql2);
            		$resultcheck = mysqli_num_rows($result2);
            	}
            	if (isset($bathroom) && isset($bedroom) && !isset($price)) {
            		$sql2 = "SELECT * from property where city='$city' AND bathroom='$bathroom' AND type='$type' AND bedroom='$bedroom';";
            		$result2 = mysqli_query($conn, $sql2);
            		$resultcheck = mysqli_num_rows($result2);
            	}
            	if (isset($bathroom) && !isset($bedroom) && isset($price)) {
            		$sql2 = "SELECT * from property where city='$city' AND bathroom='$bathroom' AND type='$type' AND price<='$price';";
            		$result2 = mysqli_query($conn, $sql2);
            		$resultcheck = mysqli_num_rows($result2);
            	}
            	if (!isset($bathroom) && isset($bedroom) && isset($price)) {
            		$sql2 = "SELECT * from property where city='$city' AND bedroom='$bedroom' AND type='$type' AND price<='$price';";
            		$result2 = mysqli_query($conn, $sql2);
            		$resultcheck = mysqli_num_rows($result2);
            	}
            	if (isset($bathroom) && isset($bedroom) && isset($price)) {
            		$sql2 = "SELECT * from property where city='$city' AND bedroom='$bedroom' AND type='$type' AND price<='$price' AND bathroom='$bathroom';";
            		$result2 = mysqli_query($conn, $sql2);
            		$resultcheck = mysqli_num_rows($result2);
            	}
            ...
            ?>
                ...
                <div class="col-lg-12 p-45">
                    <div class="found-items">
                        <h4>We found <span><?php echo $resultcheck; ?></span> properties</h4>
                </div>
